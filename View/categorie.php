...
$listcategorie = $categorie->listcategorie();
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
        ...
        <nav class="bg-white border-gray-200 dark:bg-gray-900">
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl px-4 md:px-6 py-2.5">
                <a href="" class="flex items-center">
                    <img src="../assets/image/mobile logo.png" class="h-6 mr-3 sm:h-9" alt="Logo" />
    ...
    <section class="flex flex-col m-auto justify-center">
        <h1 class="text-center font-extrabold text-blue-800 text-2xl my-4">categories</h1>
        <div class="container flex justify-center items-center m-auto w-[100%]">
            <div class="flex flex-col w-[100%] m-auto">
                <div class="w-[100%] m-auto">
                    <div class="my-4">
                        <a href="#" class="px-4 py-1 text-sm text-green-400 bg-green-200 rounded-full ml-4 w-40 ">add</a>
                    </div>
                    ...
                    <div class="border-b border-gray-200 shadow">
                        <table class="divide-y divide-gray-300 w-[100%]">
                            ...
                            <?php foreach ($listcategorie as $key => $value) { ?>
                                <tr class="whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-gray-900">
                                           <img src="../assets/image/accessorie1.png" alt="" class="rounded bg-blue-500">
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-gray-500">  <?php echo $value['nom'] ?></div>
                                    </td>
                                    <td class="px-6 py-4 text-sm text-gray-500">
